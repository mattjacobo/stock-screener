...
def get_live_gainers(min_change=1.0, min_volume=10000, limit=50):
    """
    Strong yFinance scanner with expanded universe for better results.
    """
    # Large list of volatile stocks + popular momentum names
    watchlist = [
        ...
        'RIVN','LCID','NKLA','WKHS','BLNK','FCEL','BE','RUN','ENPH','SEDG','CVNA','SPY','QQQ','IWM'
    ]
